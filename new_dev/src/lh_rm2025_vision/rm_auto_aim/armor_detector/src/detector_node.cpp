...
: Node("armor_detector", options)
{
  ...
  // Armors Publisher
  armors_pub_ = this->create_publisher<core_global::msg::Armors>(
...
void ArmorDetectorNode::imageCallback(const sensor_msgs::msg::Image::ConstSharedPtr img_msg)
{
  ...
  if (pnp_solver_ != nullptr && is_aim_task_) {
    ...
    core_global::msg::Armor armor_msg;
...
{
  lights_data_pub_ =
    this->create_publisher<core_global::msg::DebugLights>("/detector/debug_lights", 10);
  armors_data_pub_ =
    this->create_publisher<core_global::msg::DebugArmors>("/detector/debug_armors", 10);
