...
#include "core_global/msg/tracker_info.hpp"

namespace rm_auto_aim
{
using tf2_filter = tf2_ros::MessageFilter<core_global::msg::Armors>;
...
private:
  void armorsCallback(const core_global::msg::Armors::SharedPtr armors_ptr);

  void publishMarkers(const core_global::msg::Target & target_msg);
  ...
  message_filters::Subscriber<core_global::msg::Armors> armors_sub_;
  std::shared_ptr<tf2_filter> tf2_filter_;

  // Tracker info publisher
  rclcpp::Publisher<core_global::msg::TrackerInfo>::SharedPtr info_pub_;

  // Publisher
  rclcpp::Publisher<core_global::msg::Target>::SharedPtr target_pub_;
