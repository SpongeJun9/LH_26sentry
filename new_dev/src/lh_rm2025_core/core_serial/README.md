# core_serial
哨兵框架全局串口通讯模块
框架根据rm_serial_driver 模块进行修改


## Overview

本模块基于 [transport_drivers](https://github.com/ros-drivers/transport_drivers) 实现了与电控部分通讯的功能，也可作为使用 ros2 作为开发框架的参赛队的串口通讯模块参考
...
安装依赖 `sudo apt install ros-humble-serial-driver`
        `sudo apt install ros-humble-asio_cmake_module`
